...
parser.add_argument("-e", "--ignore", help="Specify paths not to be copied", nargs="+")
...
def copyAux():
    ...
    exclude = {"__pycache__", 'Doc', 'include', 'libs', 'tcl', 'Tools', 'test'}
    if nosite:
...
def generateHeader(generated_pythonhome):
    ...
    hdr = ""
    hdr += "#ifndef _h_pythoncpp_pythondefs\n"
    hdr += "#define _h_pythoncpp_pythondefs\n"
